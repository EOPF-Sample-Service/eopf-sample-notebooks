...
<div class="notebook-card" data-tags="land sentinel-2 xarray" style="display: flex; align-items: flex-start; border: 1px solid #cddff1; border-radius: 6px; padding: 14px 20px; background-color: #f9fbfe; box-shadow: 1px 1px 4px #dfeaf5;">
  ...
  <div style="flex: 1;">
    ...
    <div style="margin: 6px 0;">
      <span class="tag">land</span><span class="tag">sentinel-2</span><span class="tag">xarray</span>
    </div>
...
<div class="notebook-card" data-tags="land sentinel-2 xarray" style="display: flex; align-items: flex-start; border: 1px solid #cddff1; border-radius: 6px; padding: 14px 20px; background-color: #f9fbfe; box-shadow: 1px 1px 4px #dfeaf5;">
  <div style="width: 100px; height: 100px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; background-color: #fff; border: 1px solid #e0eaf5; border-radius: 6px; overflow: hidden; margin-right: 32px;">
    <img src="/notebooks/static/SL2P_LAI_retrieval.jpg" alt="Notebook Thumbnail" style="max-width: 100%; max-height: 100%; object-fit: contain;">
  </div>
  <div style="flex: 1;">
    <strong>Computing Leaf Area Index with Sentinel-2 in EOPF Zarr format</strong><br>
    LAI with Sentinel-2<br>
    <div style="margin: 6px 0;">
      <span class="tag">land</span><span class="tag">sentinel-2</span><span class="tag">xarray</span>
    </div>
    <a href="/notebooks/Sentinel-2/SL2P_LAI_retrieval" style="text-decoration: none; color: #1d70b8; font-weight: bold;">View Notebook</a>
  </div>
</div>
<div class="notebook-card" data-tags="security sentinel-2 xarray" style="display: flex; align-items: flex-start; border: 1px solid #cddff1; border-radius: 6px; padding: 14px 20px; background-color: #f9fbfe; box-shadow: 1px 1px 4px #dfeaf5;">
  <div style="width: 100px; height: 100px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; background-color: #fff; border: 1px solid #e0eaf5; border-radius: 6px; overflow: hidden; margin-right: 32px;">
  ...
  <div style="flex: 1;">
    ...
    <div style="margin: 6px 0;">
      <span class="tag">security</span><span class="tag">sentinel-2</span><span class="tag">xarray</span>
    </div>
...
<div class="notebook-card" data-tags="sentinel-1 land xarray" style="display: flex; align-items: flex-start; border: 1px solid #cddff1; border-radius: 6px; padding: 14px 20px; background-color: #f9fbfe; box-shadow: 1px 1px 4px #dfeaf5;">
  <div style="width: 100px; height: 100px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; background-color: #fff; border: 1px solid #e0eaf5; border-radius: 6px; overflow: hidden; margin-right: 32px;">
    <img src="/notebooks/static/EOPF-on-bright-baseline.png" alt="Notebook Thumbnail" style="max-width: 100%; max-height: 100%; object-fit: contain;">
  </div>
  <div style="flex: 1;">
    ...
    <div style="margin: 6px 0;">
      <span class="tag">sentinel-1</span><span class="tag">land</span><span class="tag">xarray</span>
    </div>
...
<div class="notebook-card" data-tags="sentinel-1 marine xarray" style="display: flex; align-items: flex-start; border: 1px solid #cddff1; border-radius: 6px; padding: 14px 20px; background-color: #f9fbfe; box-shadow: 1px 1px 4px #dfeaf5;">
  <div style="width: 100px; height: 100px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; background-color: #fff; border: 1px solid #e0eaf5; border-radius: 6px; overflow: hidden; margin-right: 32px;">
    <img src="/notebooks/static/EOPF-on-bright-baseline.png" alt="Notebook Thumbnail" style="max-width: 100%; max-height: 100%; object-fit: contain;">
  </div>
  <div style="flex: 1;">
    ...
    <div style="margin: 6px 0;">
      <span class="tag">sentinel-1</span><span class="tag">marine</span><span class="tag">xarray</span>
    </div>
...
<div class="notebook-card" data-tags="sentinel-2 marine xarray" style="display: flex; align-items: flex-start; border: 1px solid #cddff1; border-radius: 6px; padding: 14px 20px; background-color: #f9fbfe; box-shadow: 1px 1px 4px #dfeaf5;">
  <div style="width: 100px; height: 100px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; background-color: #fff; border: 1px solid #e0eaf5; border-radius: 6px; overflow: hidden; margin-right: 32px;">
    <img src="https://raw.githubusercontent.com/EOPF-Sample-Service/eopf-sample-notebooks/refs/heads/main/notebooks/static/ESA_logo_2020_Deep.png" alt="Notebook Thumbnail" style="max-width: 100%; max-height: 100%; object-fit: contain;">
  </div>
  <div style="flex: 1;">
    ...
    <div style="margin: 6px 0;">
      <span class="tag">sentinel-2</span><span class="tag">marine</span><span class="tag">xarray</span>
    </div>
...
<div style="display: flex; flex-direction: column; gap: 20px; max-width: 900px; margin-bottom: 40px;">
<div class="notebook-card" data-tags="xarray-eopf land sentinel-2" style="display: flex; align-items: flex-start; border: 1px solid #cddff1; border-radius: 6px; padding: 14px 20px; background-color: #f9fbfe; box-shadow: 1px 1px 4px #dfeaf5;">
  <div style="width: 100px; height: 100px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; background-color: #fff; border: 1px solid #e0eaf5; border-radius: 6px; overflow: hidden; margin-right: 32px;">
    <img src="/notebooks/static/EOPF-on-bright-baseline.png" alt="Notebook Thumbnail" style="max-width: 100%; max-height: 100%; object-fit: contain;">
  </div>
  <div style="flex: 1;">
    ...
    <div style="margin: 6px 0;">
      <span class="tag">xarray-eopf</span><span class="tag">land</span><span class="tag">sentinel-2</span>
    </div>
...
<div class="notebook-card" data-tags="xarray-eopf sentinel-1 land" style="display: flex; align-items: flex-start; border: 1px solid #cddff1; border-radius: 6px; padding: 14px 20px; background-color: #f9fbfe; box-shadow: 1px 1px 4px #dfeaf5;">
  <div style="width: 100px; height: 100px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; background-color: #fff; border: 1px solid #e0eaf5; border-radius: 6px; overflow: hidden; margin-right: 32px;">
    <img src="/notebooks/static/EOPF-on-bright-baseline.png" alt="Notebook Thumbnail" style="max-width: 100%; max-height: 100%; object-fit: contain;">
  </div>
  <div style="flex: 1;">
    ...
    <div style="margin: 6px 0;">
      <span class="tag">xarray-eopf</span><span class="tag">sentinel-1</span><span class="tag">land</span>
    </div>
...
<div class="notebook-card" data-tags="xarray-eopf land sentinel-3" style="display: flex; align-items: flex-start; border: 1px solid #cddff1; border-radius: 6px; padding: 14px 20px; background-color: #f9fbfe; box-shadow: 1px 1px 4px #dfeaf5;">
  <div style="width: 100px; height: 100px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; background-color: #fff; border: 1px solid #e0eaf5; border-radius: 6px; overflow: hidden; margin-right: 32px;">
    <img src="/notebooks/static/EOPF-on-bright-baseline.png" alt="Notebook Thumbnail" style="max-width: 100%; max-height: 100%; object-fit: contain;">
  </div>
  <div style="flex: 1;">
    ...
    <div style="margin: 6px 0;">
      <span class="tag">xarray-eopf</span><span class="tag">land</span><span class="tag">sentinel-3</span>
    </div>
...
<div class="notebook-card" data-tags="xcube land sentinel-3" style="display: flex; align-items: flex-start; border: 1px solid #cddff1; border-radius: 6px; padding: 14px 20px; background-color: #f9fbfe; box-shadow: 1px 1px 4px #dfeaf5;">
  <div style="width: 100px; height: 100px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; background-color: #fff; border: 1px solid #e0eaf5; border-radius: 6px; overflow: hidden; margin-right: 32px;">
    <img src="/notebooks/static/EOPF-on-bright-baseline.png" alt="Notebook Thumbnail" style="max-width: 100%; max-height: 100%; object-fit: contain;">
  </div>
  <div style="flex: 1;">
    ...
    <div style="margin: 6px 0;">
      <span class="tag">xcube</span><span class="tag">land</span><span class="tag">sentinel-3</span>
    </div>
    <a href="/notebooks/xcube_eopf_plugin/sentinel_3" style="text-decoration: none; color: #1d70b8; font-weight: bold;">View Notebook</a>
  </div>
</div>
<div class="notebook-card" data-tags="xcube sentinel-2 performance" style="display: flex; align-items: flex-start; border: 1px solid #cddff1; border-radius: 6px; padding: 14px 20px; background-color: #f9fbfe; box-shadow: 1px 1px 4px #dfeaf5;">
  <div style="width: 100px; height: 100px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; background-color: #fff; border: 1px solid #e0eaf5; border-radius: 6px; overflow: hidden; margin-right: 32px;">
    <img src="https://raw.githubusercontent.com/EOPF-Sample-Service/eopf-sample-notebooks/refs/heads/main/notebooks/static/ESA_logo_2020_Deep.png" alt="Notebook Thumbnail" style="max-width: 100%; max-height: 100%; object-fit: contain;">
  </div>
  <div style="flex: 1;">
    ...
    <div style="margin: 6px 0;">
      <span class="tag">xcube</span><span class="tag">sentinel-2</span><span class="tag">performance</span>
    </div>
...
<div class="notebook-card" data-tags="xcube sentinel-2 climate-change" style="display: flex; align-items: flex-start; border: 1px solid #cddff1; border-radius: 6px; padding: 14px 20px; background-color: #f9fbfe; box-shadow: 1px 1px 4px #dfeaf5;">
  <div style="width: 100px; height: 100px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; background-color: #fff; border: 1px solid #e0eaf5; border-radius: 6px; overflow: hidden; margin-right: 32px;">
    <img src="/notebooks/static/EOPF-on-bright-baseline.png" alt="Notebook Thumbnail" style="max-width: 100%; max-height: 100%; object-fit: contain;">
  </div>
  <div style="flex: 1;">
    ...
    <div style="margin: 6px 0;">
      <span class="tag">xcube</span><span class="tag">sentinel-2</span><span class="tag">climate-change</span>
    </div>
...
<div class="notebook-card" data-tags="sentinel-3 gdal climate-change" style="display: flex; align-items: flex-start; border: 1px solid #cddff1; border-radius: 6px; padding: 14px 20px; background-color: #f9fbfe; box-shadow: 1px 1px 4px #dfeaf5;">
  <div style="width: 100px; height: 100px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; background-color: #fff; border: 1px solid #e0eaf5; border-radius: 6px; overflow: hidden; margin-right: 32px;">
    <img src="https://raw.githubusercontent.com/EOPF-Sample-Service/eopf-sample-notebooks/refs/heads/main/notebooks/static/ESA_logo_2020_Deep.png" alt="Notebook Thumbnail" style="max-width: 100%; max-height: 100%; object-fit: contain;">
  </div>
  <div style="flex: 1;">
    ...
    <div style="margin: 6px 0;">
      <span class="tag">sentinel-3</span><span class="tag">gdal</span><span class="tag">climate-change</span>
    </div>
...
<div class="notebook-card" data-tags="openeo stac land sentinel-2" style="display: flex; align-items: flex-start; border: 1px solid #cddff1; border-radius: 6px; padding: 14px 20px; background-color: #f9fbfe; box-shadow: 1px 1px 4px #dfeaf5;">
  <div style="width: 100px; height: 100px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; background-color: #fff; border: 1px solid #e0eaf5; border-radius: 6px; overflow: hidden; margin-right: 32px;">
    <img src="https://raw.githubusercontent.com/EOPF-Sample-Service/eopf-sample-notebooks/refs/heads/main/notebooks/static/ESA_logo_2020_Deep.png" alt="Notebook Thumbnail" style="max-width: 100%; max-height: 100%; object-fit: contain;">
  </div>
  <div style="flex: 1;">
    ...
    <div style="margin: 6px 0;">
      <span class="tag">openeo</span><span class="tag">stac</span><span class="tag">land</span><span class="tag">sentinel-2</span>
    </div>
...
<div class="notebook-card" data-tags="stac sentinel 2 marine" style="display: flex; align-items: flex-start; border: 1px solid #cddff1; border-radius: 6px; padding: 14px 20px; background-color: #f9fbfe; box-shadow: 1px 1px 4px #dfeaf5;">
  <div style="width: 100px; height: 100px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; background-color: #fff; border: 1px solid #e0eaf5; border-radius: 6px; overflow: hidden; margin-right: 32px;">
    <img src="https://raw.githubusercontent.com/EOPF-Sample-Service/eopf-sample-notebooks/refs/heads/main/notebooks/static/ESA_logo_2020_Deep.png" alt="Notebook Thumbnail" style="max-width: 100%; max-height: 100%; object-fit: contain;">
  </div>
  <div style="flex: 1;">
    ...
    <div style="margin: 6px 0;">
      <span class="tag">stac</span><span class="tag">sentinel 2</span><span class="tag">marine</span>
    </div>
